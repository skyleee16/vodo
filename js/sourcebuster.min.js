...
!(function (e) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = e();
        ...
        var r;
        "undefined" != typeof window ? (r = window) : "undefined" != typeof global ? (r = global) : "undefined" != typeof self && (r = self), (r.sbjs = e());
    }
})(function () {
            ...
            1: [
                function (e, r, t) {
                    ...
                    var s = e("./init"),
                        n = {
                            init: function (e) {
                                (this.get = s(e)), e && e.callback && "function" == typeof e.callback && e.callback(this.get);
                            },
                        };
                    r.exports = n;
                },
                    ...
                    var s = e("./terms"),
                        ...
                        o = {
                            ...
                            pack: {
                                ...
                                extra: function (e) {
                                    return (
                                        o.aliases.extra.fire_date +
                                        "=" +
                                        n.setDate(new Date(), e) +
                                        o.delimiter +
                                        o.aliases.extra.entrance_point +
                                        "=" +
                                        document.location.href +
                                        o.delimiter +
                                        o.aliases.extra.referer +
                                        "=" +
                                        (document.referrer || s.none)
                                    );
                                },
                                user: function (e, r) {
                    ...
                    r.exports = {
                        ...
                        get: function (e) {
                            for (var r = this.encodeData(e) + "=", t = document.cookie.split(";"), s = 0; s < t.length; s++) {
                                ...
                                if (0 === n.indexOf(r)) return this.decodeData(n.substring(r.length, n.length));
                            }
                            return null;
                        },
                        ...
                        parse: function (e) {
                            ...
                            else for (var n in e) e.hasOwnProperty(n) && r.push(e[n]);
                    ...
                    r.exports = {
                        ...
                        getParam: function (e) {
                            for (var r = {}, t = e ? e : window.location.search.substring(1), s = t.split("&"), n = 0; n < s.length; n++) {
                                var o = s[n].split("=");
                                if ("undefined" == typeof r[o[0]]) r[o[0]] = o[1];
                    ...
                    r.exports = function (e) {
                        function r() {
                            ...
                            if (
                                ...
                                "undefined" != typeof y[h.term_param] ||
                                "undefined" != typeof y[h.content_param]
                            )
                                g(), (e = t(n.traffic.utm));
                        ...
                        function t(e) {
                            switch (e) {
                                ...
                                case n.traffic.referral:
                                    (v = n.traffic.referral), (x = x || a.getHost(document.referrer)), (D = D || n.referer.referral), (k = n.none), (w = a.parse(document.referrer).path), (C = n.none);
                                    break;
                            ...
                            var r = { type: v, source: x, medium: D, campaign: k, content: w, term: C };
                        ...
                        function g() {
                            o.set(s.containers.current_extra, s.pack.extra(h.timezone_offset), b, j, _), o.get(s.containers.first_extra) || o.set(s.containers.first_extra, s.pack.extra(h.timezone_offset), b, j, _);
                        }
                        var h = c.fetch(e),
                            y = a.getParam(),
                            j = h.domain.host,
                        ...
                        return (
                            (function () {
                                ...
                                o.get(s.containers.udata)
                                    ? ((e = parseInt(o.parse(s.containers.udata)[o.unsbjs(s.containers.udata)][s.aliases.udata.visits]) || 1), (e = o.get(s.containers.session) ? e : e + 1), (t = s.pack.user(e, h.user_ip)))
                                    : ((e = 1), (t = s.pack.user(e, h.user_ip))),
                                    o.set(s.containers.udata, t, b, j, _);
                                var n;
                                o.get(s.containers.session) ? ((n = parseInt(o.parse(s.containers.session)[o.unsbjs(s.containers.session)][s.aliases.session.pages_seen]) || 1), (n += 1)) : (n = 1),
                        ...
                        migrations: [
                            {
                                ...
                                go: function (e, r) {
                                    ...
                                    try {
                                        var i = [];
                                        for (var c in s.containers) s.containers.hasOwnProperty(c) && i.push(s.containers[c]);
                    ...
                    r.exports = {
                        fetch: function (e) {
                            ...
                            if (
                                ...
                                r.promocode ? ((t.promocode = {}), (t.promocode.min = parseInt(r.promocode.min) || 1e5), (t.promocode.max = parseInt(r.promocode.max) || 999999)) : (t.promocode = !1),
                                r.typein_attributes && r.typein_attributes.source && r.typein_attributes.medium
                                    ? ((t.typein_attributes = {}), (t.typein_attributes.source = r.typein_attributes.source), (t.typein_attributes.medium = r.typein_attributes.medium))
                                ...
                                for (var o = 0; o < r.referrals.length; o++) r.referrals[o].host && t.referrals.push(r.referrals[o]);
                            if (((t.organics = []), r.organics && r.organics.length > 0)) for (var a = 0; a < r.organics.length; a++) r.organics[a].host && r.organics[a].param && t.organics.push(r.organics[a]);
                            return (
